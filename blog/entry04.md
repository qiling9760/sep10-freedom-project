...
I tinkered with SASS by copied the code on [W3 Schools](https://www.w3schools.com/sass/default.php) to [Sass: Playground](https://sass-lang.com/playground/) and change around with the code. 
...
```
It could nest `font-family`, `font-size`, and `font-weight` together because they have the same prefix _font_. And I knew some properties that have the same prefix such as the `border width`, `border-style`, and `border-color`. So, I tried to nest them together and it worked. 
